...
<div class="container">
  ...
  <div class="jumbotron">
    ...
    <div class="text-center"><a class="btn btn-primary btn-lg" href="https://github.com/Philpof" role="button">Mon GitHub</a></div>
      ...
      <div class="col-sm d-flex justify-content-around">
        <div class="card" style="width: 15rem;">
          ...
          <div class="card-body">
            ...
            <a href="#" class="btn btn-primary">C'est par là !</a>
          </div>
        </div>
      </div>
      <!-- Card n°2 -->
      ...
      <div class="col-sm d-flex justify-content-around">
        <div class="card" style="width: 15rem;">
          ...
          <div class="card-body">
            ...
            <a href="#" class="btn btn-primary">Suivre le lapin blanc</a>
          </div>
        </div>
      </div>
      <!-- Card n°4 -->
      <div class="col-sm d-flex justify-content-around">
        <div class="card" style="width: 15rem;">
          ...
          <div class="card-body">
            ...
            <a href="#" class="btn btn-primary">Go Go Git !</a>
          </div>
        </div>
      </div>
      <!-- Card n°5 -->
      <div class="col-sm d-flex justify-content-around">
        <div class="card" style="width: 15rem;">
          ...
          <div class="card-body">
            ...
            <a href="#" class="btn btn-primary">Boum !</a>
          </div>
        </div>
      </div>
    </div>
